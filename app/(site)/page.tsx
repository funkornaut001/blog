...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <p className="mt-3 text-xl text-gray-600">Gm, I am Trevor a self taught developer building blockchain applications, Chat-GPT powered tools, and learning about smart contract security</p>
